...
基于 PRD v0.1 的技术实施方案。全 Serverless 架构，CDK Python 部署，目标账号 926093770964，主 Region ap-northeast-1。
...
**部署 Region：ap-northeast-1（东京）** — 独立于被监控 Region，确保控制平面不受影响。
...
| AWS Account 926093770964 | ✅ 可用 | ap-northeast-1 |
